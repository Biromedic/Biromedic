...
- 🌱 I’m currently working on an AI-powered fitness app project with a focus on backend development using **Java** and **Spring Boot**. We're aiming for a robust user experience with personalized workout plans and community-driven features.

- 🔭 Recent focus areas include:
  - Setting up **CI pipelines** and **unit/integration testing** to ensure code stability
  - Optimizing database queries using **Lazy/Eager loading** strategies
